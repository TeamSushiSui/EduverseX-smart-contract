import { bcs } from '.pnpm/@mysten+sui@1.11.0_typescript@5.6.2/node_modules/@mysten/sui/bcs';
import type { SuiClient, SuiTransactionBlockResponseOptions } from '.pnpm/@mysten+sui@1.11.0_typescript@5.6.2/node_modules/@mysten/sui/client';
...
export declare class SerialTransactionExecutor {
    ...
    executeTransaction(transaction: Transaction | Uint8Array, options?: SuiTransactionBlockResponseOptions): Promise<{
        digest: string;
        effects: string;
        data: import(".pnpm/@mysten+sui@1.11.0_typescript@5.6.2/node_modules/@mysten/sui/client").SuiTransactionBlockResponse;
    }>;
}
